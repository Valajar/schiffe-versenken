...
let score = 0;
import {treffer, shots, leben, diffMult, restartGame, torpedoShots} from './main.js';
...
export function calculateScore(treffer, leben, diffMult, shots) {
    let score = (treffer * 500) * ((1 + leben) * 0.8) * (diffMult) - (shots * 50);
    if (score < 0) {
        score = 0;
    }
    return score;
...
export function updateTorpedoAvailability(torpedoShots) {
